...
namespace Xamarin.Forms
{
    ...
    public partial class CustomStreamImageSource : ImageSource, IStreamImageSource
    {
        public static readonly BindableProperty StreamProperty = BindableProperty.Create("Stream", typeof(Func<CancellationToken, Task<Stream>>), typeof(CustomStreamImageSource),
